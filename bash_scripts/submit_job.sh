...
python3 /projects/ovcare/classification/Ali/Bladder_project/codes/run_test.py \
    --model_name "$model" \
    --split_name "$fold" \
    --batch_size 1 \
    --mag 20x \
    ...
    --path_to_folds /projects/ovcare/classification/Ali/Bladder_project/Dataset/scripts/data_folds.json \
